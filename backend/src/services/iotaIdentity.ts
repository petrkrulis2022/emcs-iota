...
function initializeMockIdentities() {
  const identities: IOTAIdentityDID[] = [
    ...
    },
    {
      ...
      verifiableCredentials: {
        seedNumber: 'GB00445790002',
        companyName: 'TESCO PLC',
        vatNumber: 'GB445790002',
        country: 'United Kingdom',
        countryCode: 'GB',
        address: 'Tesco House, Shire Park, Kestrel Way',
        city: 'Welwyn Garden City',
        postalCode: 'AL7 1GA',
        email: 'corporate@tesco.com',
        phone: '+44 1992 632222',
        contactPerson: 'Corporate Affairs',
        authorizedGoods: ['Wine', 'Beer', 'Spirits', 'Tobacco', 'Energy'],
        licenseNumber: 'GB-EXCISE-1947-445790',
        issuedBy: 'HM Revenue & Customs (United Kingdom)',
        issuedAt: '1947-11-27T00:00:00Z',
        expiresAt: '2025-12-31T23:59:59Z',
      },
      domainLinkage: {
        domain: 'tesco.com',
